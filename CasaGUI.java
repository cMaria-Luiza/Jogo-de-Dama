...
public class CasaGUI extends JButton {
    ...
    public int getTipoPeca() {
        ...
        if (icone == PEDRA_BRANCA) {
            return PEDRAS_BRANCAS;
        }
        else if (icone == PEDRA_VERMELHA) {
            return PEDRAS_VERMELHAS;
        }
        else if (icone == DAMA_BRANCA) {
            return DAMAS_BRANCAS;
        }
        else if (icone == DAMA_VERMELHA) {
            return DAMAS_VERMELHAS;
        }
        else {
            return SEM_PECA;
        }
